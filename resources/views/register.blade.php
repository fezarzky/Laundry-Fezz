            ...
            <div class="col-lg-8 col-md-10">
                <div class="card register-card">
                    ...
                    <div class="card-body p-5">
                        @php
                        session_start();
                        include app_path('../routes/config.php');
                        ...
                        <form action="/process/register_process" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3" style="border-radius: 15px;" required></textarea>
                            </div>
                        ...
                        <div class="text-center">
                            <p class="mb-0">Sudah punya akun? 
                                <a href="/login" class="text-primary text-decoration-none fw-bold">Login disini</a>
                            </p>
                        </div>
                    </div>
                </div>
